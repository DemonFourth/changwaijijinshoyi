module.exports = {
  ...
  rules: {
    ...
    'color-function-notation': null,      // 允许旧式颜色函数
    'alpha-value-notation': null,         // 允许旧式alpha值
    ...
    'selector-max-compound-selectors': null, // 允许复合选择器
    'no-descending-specificity': null,    // 允许特殊性顺序问题
    ...
    'shorthand-property-no-redundant-values': null,  // 允许冗余值
    ...
    'comment-empty-line-before': null,    // 允许注释前无空行

    // 媒体查询规则
    'media-feature-range-notation': null, // 允许旧式范围表示法

    // 通用规则
    'no-duplicate-selectors': null,       // 允许重复选择器
    'no-empty-source': true,              // 禁止空源
    'no-invalid-double-slash-comments': true,
    'rule-empty-line-before': null,       // 允许规则前无空行
    ...
    // 行规则
    'declaration-block-single-line-max-declarations': null // 允许单行多声明
  }
};
