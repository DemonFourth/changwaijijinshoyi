const TradeModalHelper = {
    ...
    renderTradeFormSections(data) {
        ...
        html += '<input type="number" id="input-trade-date-year" class="date-part-input date-part-year" value="' + yearVal + '" placeholder="年" min="1900" max="2100" step="1" maxlength="4">';
        html += '<span class="date-separator">/</span>';
        html += '<input type="number" id="input-trade-date-month" class="date-part-input date-part-month" value="' + monthVal + '" placeholder="月" min="1" max="12" step="1" maxlength="2">';
        html += '<span class="date-separator">/</span>';
        html += '<input type="number" id="input-trade-date-day" class="date-part-input date-part-day" value="' + dayVal + '" placeholder="日" min="1" max="31" step="1" maxlength="2">';
        html += '<button type="button" class="date-picker-trigger" id="btn-date-picker" title="选择日期">📅</button>';
        html += '</div>';
        html += '<input type="date" id="input-trade-date" class="hidden-date-picker" value="' + dateVal + '" tabindex="-1">';
        html += '</div>';
