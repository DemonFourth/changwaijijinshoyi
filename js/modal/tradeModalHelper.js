const TradeModalHelper = {
    ...
    renderTradeFormSections(data) {
        ...
        html += '<input type="text" id="input-trade-date-year" class="date-part-input date-part-year" value="' + yearVal + '" placeholder="年" maxlength="4" inputmode="numeric">';
        html += '<span class="date-separator">/</span>';
        html += '<input type="text" id="input-trade-date-month" class="date-part-input date-part-month" value="' + monthVal + '" placeholder="月" maxlength="2" inputmode="numeric">';
        html += '<span class="date-separator">/</span>';
        html += '<input type="text" id="input-trade-date-day" class="date-part-input date-part-day" value="' + dayVal + '" placeholder="日" maxlength="2" inputmode="numeric">';
